...
ALLOWED_HOSTS = ["*",  "nh-transports2025.up.railway.app", "nh-transports-2025-production.up.railway.app",
    "localhost",
    "127.0.0.1",]

CSRF_TRUSTED_ORIGINS = [
    "https://nh-transports2025.up.railway.app", "nh-transports-2025-production.up.railway.app",
]
...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'ovyc asaq dcgt ncqb')
